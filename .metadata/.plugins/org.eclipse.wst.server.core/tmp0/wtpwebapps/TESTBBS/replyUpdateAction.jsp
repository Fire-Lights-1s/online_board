...
<body>
	...
	if(!userID.equals(reply.getReplyUserID())){
		...
		if (request.getParameter("replyID") == null || request.getParameter("replyContent") == null
				|| request.getParameter("replyID").equals("") || request.getParameter("replyContent").equals("")) {
